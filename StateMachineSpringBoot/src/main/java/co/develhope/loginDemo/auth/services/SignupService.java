...
public class SignupService{
    ...
    public User signup(SignupDTO signupDTO) throws Exception{
        return this.signup(signupDTO,Role.REGISTERED);
    }
    ...
    public User signup(SignupDTO signupDTO,String role) throws Exception{
        ...
        Set<co.develhope.loginDemo.user.entities.Role> roles = new HashSet<>();
        Optional<co.develhope.loginDemo.user.entities.Role> userRole = Optional.ofNullable(
